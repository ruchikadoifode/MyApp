$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("test/resources/com/qtpselenium/app/salesforce/login/login.feature");
formatter.feature({
